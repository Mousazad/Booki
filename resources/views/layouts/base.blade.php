...
<nav class="navbar navbar-expand-sm navbar-light" style="background-color:#1fa0db">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="{{ url('images/logo2.png') }}" alt="Avatar Logo" style="width:40px;" class="rounded-pill">
        </a>
        <div class="collapse navbar-collapse" id="mynavbar">
            ...
            @if (Route::has('login'))
                ...
                @else
                    <div class="dropdown">
                        <button type="button" class="btn btn-outline-white dropdown-toggle" data-bs-toggle="dropdown">
                            پنل کاربری
                        </button>
                        <ul class="dropdown-menu">
                            <li><a
